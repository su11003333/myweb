...
<div class="cbp-l-inline">
    <div class="cbp-l-inline-left">
        {{--<a href="{{$work->banner}}" class="cbp-lightbox">--}}
            {{--<img src="{{$work->banner}}" alt="">--}}
        {{--</a>--}}
        {{--<br>--}}

        <div id="ajax_work_slick">
            @if($work->workscategories->name == "影片")
                ...
                @else
                <div>
                    <img  width="100%" style="height: 100%;" src="{{$work->banner}}" alt="">
                </div>
                @endif
            ...
            @if(count($work->worksfeatures)>0)
                @foreach($work->worksfeatures as $feature)
                    <div>
                        <img  width="100%" src="{{$feature->path}}" alt="">
                    </div>
...
{{----}}
    ...
    <div class="cbp-l-inline-right">
        <div class="cbp-l-inline-title">{{$work->title}}</div>
        <div class="cbp-l-inline-subtitle">{!! $work->intro !!}</div>
        ...
        {{--<div class="cbp-l-inline-desc">{!! $work->body !!}</div>--}}

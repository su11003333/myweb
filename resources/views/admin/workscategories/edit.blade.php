    ...
    <div class="row">
        <div class="col-md-6 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_title">
                    <h2>Edit Works Categories  <small></small></h2>
                ...
                <div class="x_content">
                    ...
                    {!! Form::model($workscategory,['method'=>'PATCH','action'=>['AdminWorkscategoriesController@update',$workscategory->id]]) !!}

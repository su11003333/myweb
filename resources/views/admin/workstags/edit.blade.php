    ...
    <div class="row">
        <div class="col-md-6 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_title">
                    <h2>Edit Works Tag <small></small></h2>
                ...
                <div class="x_content">
                    ...
                    {!! Form::model($workstag,['method'=>'PATCH','action'=>['AdminWorkstagsController@update',$workstag->id]]) !!}
                    ...
                    @if (Route::has('login'))
                        @if (Auth::user()->isAdmin())
                            ...
                            {!! Form::open(['method'=>'DELETE','action'=>['AdminWorkstagsController@destroy',$workstag->id]]) !!}
